...
- Post-merge note (2026-09-06): whether `conductor-run` still exists is **unverifiable from the repo** — it is named only by the Blobs-era PHASE1 runbook and a 2026-08-04 cost note (`docs/plan/HANDOFF.md:514`). If it does exist it runs whatever image it was last updated with by hand.

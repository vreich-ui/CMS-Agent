  ...
  },
  {
    ...
    "schema": {
      ...
      "properties": {
        ...
        "engineDecision": {
          "type": "object",
          "description": "economic_decision.v1 appended by conductor code after the model returns; this is the only economic decision that may halt the run."
        }
      }
    },
    "inputSchema": {
      ...
      "properties": {
        ...
        "runCostEstimate": {
          "type": "object",
          "description": "Qualified current-route run-cost evidence prefetched by the conductor; the engine verifies it independently."
        },
        "trafficEstimate": {
          "type": "object",
          "description": "Tenant-attributed observation-window evidence prefetched by the conductor; the engine verifies it independently."
        }
      }
    },
    "outputSchema": {

...
export const BLOCKER_SOURCE_CLASSES: Readonly<Record<string, BlockerSourceClass>> = {
  ...
  artifact_plan: { class: "integrity", why: "The media plan. A slot the planner could not specify is a slot nothing can materialize — a structural gap, not an editorial preference." },
  artifact_materializer: { class: "integrity", why: "Media artifacts. An artifact that was never materialized for THIS request is a broken render, not an editorial preference." },

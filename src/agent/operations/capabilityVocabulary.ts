...
const CAPABILITY_VOCABULARY: readonly CapabilityVocabularyEntry[] = [
  ...
  },
  {
    ...
    description: "Revise images and their placements within a batch of web page templates.",
    evidence: "No tenant dialect in this codebase names a verb for this today (image_template_revision, A9, is unimplemented) — always reported not_supported, never a per-tenant configuration gap. See capabilityReadiness.ts."
  }
] as const;
